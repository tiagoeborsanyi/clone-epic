...
const Footer = () => (
  <div className='footer'>
    ...
    <div className='footer-politics'>
      <ul className='footer-politics__items'>
        <li className='footer-politics__item'>Termos de Serviço</li>
        <li className='footer-politics__item'>Politica de Privacidade</li>
        <li className='footer-politics__item'>Politica de Reembolso da Loja</li>
      </ul>
      <div className='footer-politics__arrows'>
        <div className='footer-politics__arrow'><SiEpicgames /></div>
        <div className='footer-politics__arrow'><SiUnrealengine /></div>
      </div>
    </div>
  </div>  
)
